                ...
                <td>
                    <c:choose>
                        <c:when test="${list.getStatus() == 'Đang hoạt động'}">
                            ...
                            <button style="background-color: red; color: white;"><a href="landlordlist?action=unActive&userId=${list.id}" style="text-decoration: none; ">Khóa</a></button>
                        </c:when>
                        <c:otherwise>
                            <input type="hidden" name="action" value="active">
                            <input type="hidden" name="userId" value="${list.id}">
                            <button style="background-color: #0C9C14; color: black"><a href="landlordlist?action=active&userId=${list.id}" style="text-decoration: none;">Kích hoạt</a></button>
                        </c:otherwise>
                    </c:choose>
                    <button style="background-color: #0C9C14; color: white;"><a href="/landLordDetail?idUser=${list.id}" style="text-decoration: none; ">Chi Tiết</a></button>
                </td>
            </tr>
        </c:forEach>
    </table>
