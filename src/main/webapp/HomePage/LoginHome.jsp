...
<div class="footer-area">
    <div class=" footer">
        <div class="container">
            <div class="row">
                <div class="col-md-3 col-sm-6 wow fadeInRight animated animated"
                     style="visibility: visible; animation-name: fadeInRight;">
                    <div class="single-footer">
                        <h4>About us </h4>
                        <div class="footer-title-line"></div>
                        <img src="assets/img/footer-logo.png" alt="" class="wow pulse animated" data-wow-delay="1s"
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="bottom-menu pull-right">
                    <ul>
                        <li><a class="wow fadeInUp animated animated" href="#" data-wow-delay="0.2s"
                               style="visibility: visible; animation-delay: 0.2s; animation-name: fadeInUp;">Home</a>
                        </li>
