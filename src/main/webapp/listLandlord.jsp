...
<head>
    ...
    <title>GARO ESTATE | List User/Landlord</title>
            ...
            <div class="collapse navbar-collapse yamm" id="navigation">
                    ...
                    <c:choose>
                        <c:when test="${not empty username}">
                            <div class="dropdown">
                                ...
                                <ul class="dropdown-menu" style="margin-top: 0px; margin-right: 120px;">
                ...
                <ul class="main-nav nav navbar-nav navbar-right">
                    <li class="dropdown ymm-sw " data-wow-delay="0.1s">
                        <a href="home-page.jsp" class="dropdown-toggle active" data-toggle="dropdown" data-hover="dropdown"
        ...
        <div class="container">
            <div class="row">
                <div class="page-head-content">
                    <h1 class="page-title">List User/ Landlord</h1>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="center">
        <table class="table table-striped">
            ...
            <c:forEach var="user" items="${userList}">
                <tr>
                    <td><img src="${user.urlImage}" alt="Avatar of User" class="avatar-img"></td>
                    <td>${user.fullName}</td>
                    <td>${user.phone}</td>
                    <td>${user.revenue}</td>
                    <td>${user.numberHouseForRent}</td>
                    <td>${user.status}</td>
                    <td>
                        <c:choose>
                            <c:when test="${user.status eq 'Đang hoạt động'}">
                                <a href="lock?id=${user.id}">Khóa</a>
                            </c:when>
                            <c:when test="${user.status eq 'Khóa'}">
                                <a href="unlock?id=${user.id}">Mở khóa</a>
                            </c:when>
                            <c:when test="${user.status eq 'Đang chờ'}">
                                <a href="approve?id=${user.id}">Duyệt</a>
                                <a href="reject?id=${user.id}">Từ chối</a>
                            </c:when>
                        </c:choose>
                    </td>
                </tr>
