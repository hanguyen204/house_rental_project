                ...
                <c:choose>
                            ...
                            <ul class="dropdown-menu" style="margin-top: 0px; margin-right: 120px;">
                                ...
                                <li><a href="#">Quản lý đăng tin</a></li>
                                 <c:if test="${userType eq 'Admin'}">
                                    <li><a href="listLandlord.jsp">Quản lý tài khoản</a></li>
                                </c:if>
                    ...
                    <c:otherwise>
                        <button class="navbar-btn nav-button wow bounceInRight login"
                                onclick=" window.open('login-register.jsp')" data-wow-delay="0.45s">SIGN IN / SIGN UP
                        </button>
                    </c:otherwise>
                </c:choose>
            </div>
            <ul class="main-nav nav navbar-nav navbar-right">
                ...
                <%--<c:choose>
                    <c:when test="${userType eq 'Admin'}">
                        <li class="wow fadeInDown" data-wow-delay="0.2s"><a class="" href="listLandlord.jsp">Administrator</a></li>
                    </c:when>
                    <c:otherwise>
            ...
            <ul class="nav navbar-nav navbar-right">
                <li class="dropdown">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                        <c:choose>
                            <c:when test="${not empty username}">
                                <img src="${user.urlImage}" alt="Avatar" class="img-circle">
                                <span class="caret"></span>
                            </c:when>
                            <c:otherwise>
                                SIGN IN / SIGN UP
